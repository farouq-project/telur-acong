        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {notifications.map((n) => (
              <div
                key={n.id}
                className={`rounded-xl p-4 border shadow-sm transition-colors ${n.isRead ? "bg-white border-gray-100" : "bg-blue-50 border-blue-100"}`}
              >
                <div className="flex items-start gap-3">
                  <div className={`w-8 h-8 rounded-lg shrink-0 flex items-center justify-center text-xs font-semibold mt-0.5 ${typeColors[n.type]}`}>
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {!n.isRead && (
                        <button
                          ...
                          className="p-1.5 rounded-lg hover:bg-blue-100 shrink-0 mt-0.5"
